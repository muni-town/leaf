...
fn read_only_module_db_authorizer(ctx: &libsql::AuthContext) -> libsql::Authorization {
    match (ctx.action, ctx.database_name) {
        ...
        (libsql::AuthAction::Function { function_name }, _db) => match function_name {
            ...
            | "json_set" | "json_extract" | "json_each" | "max" | "min" | "sum" | "avg"
            | "count" | "total" | "group_concat" | "abs" | "round" | "length" | "substr"
            | "substring" | "trim" | "ltrim" | "rtrim" | "upper" | "lower" | "replace"
            | "instr" | "printf" | "format" | "ifnull" | "nullif" | "iif" | "typeof" | "date"
            | "time" | "datetime" | "strftime" | "unixepoch" => libsql::Authorization::Allow,
